...
const cases: CaseStudyData[] = [
  {
    id: "triple-w",
    industry: "RV Rental",
    ownerName: "Westin W. Walker",
    company: "Triple W Rentals",
    city: "Quebec, CA",
    image: "/images/testimonials/tyler-w.webp",
    metric: { value: "$41,085", label: "revenue in 4 months" },
    quote: "From $900/month to five-figure months — every system shipping on time.",
    tags: ["Local SEO", "Conversion site", "Booking flow"],
    href: "/case-studies/triple-w-rentals",
  },
  {
    id: "elite-barbershop",
    ...
    metric: { value: "$14", label: "cost per booked call" },
    quote: "Bookings come in while I'm cutting hair. The system runs itself.",
    tags: ["Google Ads", "AI lead qualifier", "Brand site"],
    href: "/case-studies/elite-barbershop",
  },
  {
    id: "culture-barbershop",
    industry: "Barbershop Rebrand",
    ownerName: "Tobari",
    company: "Culture Barbershop",
    city: "Montreal, QC",
    image: "/images/testimonials/mike-s.webp",
    metric: { value: "Premium", label: "brand identity & market position" },
    quote: "Customers walk in expecting the price now. The brand did the work.",
    tags: ["Brand identity", "Conversion website", "Positioning"],
    href: "/case-studies/culture-barbershop",
  },
  {
    ...
    quote: "I stopped chasing leads. Now I pick the jobs I want to take.",
    tags: ["Local SEO", "Google Ads", "Booking flow"],
    href: "/case-studies/absolute-painting",
  },
  {
    id: "centre-dentaire",
    ...
    metric: { value: "<60s", label: "lead response time, 0 calls lost" },
    quote: "Patients book themselves. The chair is full every week.",
    tags: ["AI Voice Agent", "Booking automation", "Trust signals"],
    href: "/case-studies/centre-dentaire-saint-elzear",
  },
];
